...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('/ui/css/ani-car.css') }}">
...
<body>
            ...
            <div class="popup-inner">
                ...
                <div class="popup_content">
                    <div class="banner_location inline_top">
                        <img src="{{ asset('/ui/images/Group.svg') }}" alt="Logo">
                    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <img style="width: 100px;" src="{{ asset('/ui/images/Yotrip_logo-website-01.png') }}"
                        alt="Header Avatar">
                </a>
    ...
    <script>
        ...
        function setLogo(href) {
            ...
            let url1 = href + "/ui/images/Yotrip_logo-website-01.png"
            let url2 = href + "/ui/images/Group.svg"
            if (activeHeader) {

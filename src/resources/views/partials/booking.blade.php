            ...
            <div class="col-md-12 featured-top-booking">
                <div class="row no-gutters">
                    <div class="col-md-6 d-flex align-items-center">
                        <form autocomplete="off" action="{{ route('search.car') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input onclick="popupOpen()" type="text" class="form-control" id="res"
                                    value="{{$_GET['address']}}" name="address" data-i18n-placeholder="home.booking.pickLocationPlaceholder"
                                    readonly>
                                @else

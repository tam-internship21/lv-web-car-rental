        ...
        <tbody>
            <tr>
                <td style="text-align: center;padding: 30px;">
                    ...
                    <p style="text-align: left;margin-bottom:15px;color: #606060;">Xin chào {{$email}},</p>
                    ...
                    <p style="text-align: left;color: #606060;font-size: 14px;">Mã khôi phục : <b style="color:red;letter-spacing: 5px;">{{$reset_code}}</b></p>

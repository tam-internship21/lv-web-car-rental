    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card-box">
                ...
                <?php if($data->image!=""): ?>
                <div class="form-group mb-2">
                    <img src="/public/upload/images/news/large/<?php echo e($data->image); ?>" style="width: auto;max-width: 100%">
                </div>
                <?php endif; ?>
                <div class="form-group mb-2">
                    <?php
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hcm_tourism/public_html/app/Modules/Dashboard/Views/news/edit.blade.php ENDPATH**/ ?>
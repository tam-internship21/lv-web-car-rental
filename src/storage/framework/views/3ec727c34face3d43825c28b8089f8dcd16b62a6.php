                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="day_working" value="<?php echo e(old('day_working')); ?>" class="form-control form-control-sm" placeholder="Ex: thứ 2 - thứ 5">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            <label>Thời gian mở cửa</label>
                            <input type="text" name="time_working" value="<?php echo e(old('time_working')); ?>" class="form-control form-control-sm" placeholder="Ex: 8h-17h">
                        </div>
                    </div>
                </div>
                <div class="form-group mb-2">
                    <label>Địa chỉ</label>
                    <input type="text" name="address" value="<?php echo e(old('address')); ?>" class="form-control form-control-sm" placeholder="Ex: 123 Cach Mang Thang 8,">
                </div>
                <div class="form-group row">
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            <label>Website</label>
                            <input type="text" name="website" value="<?php echo e(old('website')); ?>" class="form-control form-control-sm" placeholder="Ex: www.abc.com">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-2">
                            <label>Quận/huyện</label>
                            <input type="text" name="district" value="<?php echo e(old('district')); ?>" class="form-control form-control-sm" placeholder="Ex: Quan 1">
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hcm_tourism/public_html/app/Modules/Dashboard/Views/post/add.blade.php ENDPATH**/ ?>
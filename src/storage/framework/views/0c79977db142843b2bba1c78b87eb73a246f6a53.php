        ...
        <div class="splide">
            <div class="splide__track" style="padding: 10px 0;">
                <ul class="splide__list">
                    <?php $__currentLoopData = $region; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <li style="background: url(<?= $location->photo ?>) no-repeat center center;border: 5px solid #E85626" class="splide__slide snip0019">
                        <a href="<?php echo e(route('car.location',$encode)); ?>">
                            <figcaption>
                                <div>
                                    <h2></h2>
                                </div>
                                <div>
                                    <p><?php echo e($location->title); ?></p>
                                </div>
                                <a href="<?php echo e(route('car.location',$encode)); ?>"></a>
                            </figcaption>
                        </a>
                    </li>
                    <?php endif; ?>
...
</style><?php /**PATH C:\xampp\htdocs\Yotrip\resources\views/partials/location.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/ui/css/ani-car.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(asset('/ui/css/styles.css')); ?>">

    <link rel="icon" href="<?php echo e(asset('/ui/images/Yotrip_new2.png')); ?>" type="image/x-icon" />
    <?php echo $__env->yieldPushContent('styles'); ?>
    <script src="<?php echo e(asset('/ui/js/jquery-3.2.1.min.js')); ?>"></script>
            ...
            <div class="popup-inner">
                ...
                <div class="popup_content">
                    <div class="banner_location inline_top">
                        <img src="<?php echo e(asset('/ui/images/Group.svg')); ?>" alt="Logo">
                    </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    ...
                    <img style="width: 100px;" src="<?php echo e(asset('/ui/images/Yotrip_logo-website-01.png')); ?>"
                        alt="Header Avatar">
                </a>
                            ...
                            <li class="nav-item dropdown d-flex" id="showUser">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php else: ?>
                                        <img style="width: 36px;height: 36px;margin-right: 10px;border-radius: 50%;margin-top: 12px;"
                                            class="img-fluid"
                                            src="<?php echo e(asset('/backend/assets/images/users/user-1.jpg')); ?>"
                                            alt="Header Avatar">
                                    <?php endif; ?>
                                <?php endif; ?>

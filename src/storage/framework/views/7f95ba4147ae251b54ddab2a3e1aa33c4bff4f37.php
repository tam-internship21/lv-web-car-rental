                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id="<?php echo e($value->id); ?>">
                                            ...
                                            <td style="display:flex" data-ispay="<?php echo e($value->is_pay); ?>">
                                                <?php if(!empty($value->hash_wta)): ?>
                                                <a href="https://bscscan.com/tx/<?php echo e(json_decode($value->hash_wta)->transactionHash); ?>" target="_blank"><i class="icon-arrow-right-circle"></i> Transaction</a>
                                                <?php endif; ?>
                                                <!--div class="dropdown">
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wallet_wta_finance/public_html/app/Modules/Dashboard/Views/kyc/transfer.blade.php ENDPATH**/ ?>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    <label>Mô tả</label>
                    <textarea name="content" rows="5" class="form-control form-control-sm"><?php echo e(old('content',$data->content)); ?></textarea>
                </div>
            </div>
        </div>
        <div class="col-md-4">
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hcm_tourism/public_html/app/Modules/Dashboard/Views/tips/edit.blade.php ENDPATH**/ ?>
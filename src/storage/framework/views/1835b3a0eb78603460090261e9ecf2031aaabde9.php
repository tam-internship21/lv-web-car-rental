            ...
            <div class="row no-gutters">
                <div class="col-xl-12">
                    <div class="auth-form">
                        ...
                        <form action="<?php echo e(route('ico.users.register_post')); ?>" method="post">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('ICO::layoutpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wallet_wta_finance/public_html/app/Modules/ICO/Views/users/register.blade.php ENDPATH**/ ?>
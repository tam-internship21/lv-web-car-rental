...
<head>
  ...
  <link rel="icon" href="../public/ui/images/icon.svg" type="image/x-icon" />
    <link rel="stylesheet" href="{{asset('public/ui/css/styles.css')}}">
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-right">
                                <div class="logo">
                                  <img src="../public/ui/images/Yotrip_logo-website-01.png" class="img-fluid" alt="Logo" style="width: 30%;

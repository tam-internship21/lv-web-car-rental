...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/ui/css/ani-car.css') }}">
    ...
    @stack('styles')
    <script src="{{ asset('public/ui/js/jquery-3.2.1.min.js') }}"></script>
            ...
            <div class="popup-inner">
                ...
                <div class="popup_content">
                    <div class="banner_location inline_top">
                        <img src="{{ asset('public/ui/images/Group.svg') }}" alt="Logo">
                    </div>
                    <div class="inner_location inline_top">
                        <form id="submitform2" method="GET" class="form-group light_circle" action="{{ url('/') }}">
                            <div class="fa_light_circle"></div>
                            <input id="addressId" type="text" name="address" placeholder="Chọn điểm xuất phát của bạn">
                           
                            {{-- <div class="option_location">onkeydown="openLocation()"
                                <div class="group_op">
                                    <div class="ic_location">
                                        <i class="fa fa-map-marker"></i>
                                    </div>
                                    <div class="info_location">Ho Chi Minh city</div>
                                </div>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <img style="width: 100px;" src="{{ asset('public/ui/images/Yotrip_logo-website-01.png') }}"
                        alt="Header Avatar">
                </a>
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        ?>"><a
                                href="{{ route('car') }}" class="nav-link" data-i18n="header.vehicle"></a>
                        </li>
                        ...
                        ?>"><a
                                href="{{ route('contacts') }}" class="nav-link" data-i18n="header.contact"></a>
                        </li>
                            ...
                            <li class="nav-item dropdown d-flex" id="showUser">
                                @if (Auth()->user()->social_type == 'google')
                                    <img style="width: 36px;height: 36px;margin-right: 10px;border-radius: 50%;margin-top: 12px;"
                                        class="img-fluid" src="{{ Auth()->user()->photo }}" alt="Header Avatar">
                                @else
                                    @if (Auth()->user()->photo)
                                        <img style="width: 36px;height: 36px;margin-right: 10px;border-radius: 50%;margin-top: 12px;"
                                            class="img-fluid" src="{{ Auth()->user()->photo }}"
                                            alt="Header Avatar">
                                    @else
                                        <img style="width: 36px;height: 36px;margin-right: 10px;border-radius: 50%;margin-top: 12px;"
                                            class="img-fluid"
                                            src="{{ asset('public/backend/assets/images/users/user-1.jpg') }}"
                                            alt="Header Avatar">
                                    @endif
                                @endif
                                <div class="dropdown-toggle nav-link" style="padding-left: 0px !important;"
                                    role="button" id="more">{{ Auth::user()->name }}</div>
                                <div class="dropdown-menu" aria-labelledby="more" id="showUser2"
                                    ...
                                    @if (Auth::user()->role == 'mod')
                                        <a class="dropdown-item"
                                            href="{{ url('/vn/bang-dieu-khien') }}">Dashboard</a>
                                    @endif
                                    <!-- Kết thúc -->
                                    @php
                                        $encode = encrypt(Auth::user()->id);
                                    @endphp
                                    <a class="dropdown-item" href="{{ route('user.profile', $encode) }}">Account</a>
                                    @if (Auth::user()->id)
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a href="{{ route('user.register') }}" class="nav-link btn btn-outline-white"

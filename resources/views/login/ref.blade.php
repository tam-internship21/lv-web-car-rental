                ...
                <div class="container-fluid form-login">
                    <div class="row no-gutters">
                        <div class="col-md-6 col-sm-12">
                            <div class="form-left">
                                <div class="logo">
                                    <img src="{{asset('public/ui/images/about.jpg')}}" alt="Logo">
                                </div>
                                <div class="group-icon">
                                    <div class="icon-item">
                                        <a href="{{ url('auth/google')}}">
                                            <img src="{{asset('public/ui/images/logo-google.png')}}" class="img-fluid img-base"
                                                alt="Google">
                                        </a>
                                    </div>
                                    <div class="icon-item">
                                        <a href="{{url('/getInfo-facebook/facebook')}}">
                                            <img src="{{asset('public/ui/images/logo-fb.png')}}" class="img-fluid img-base"
                                                alt="Facebook">
                                        </a>
                                    </div>
                                    <div class="icon-item">
                                        <a href="">
                                            <img src="{{asset('public/ui/images/logo-apple.png')}}" class="img-fluid img-base"
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-right">
                                <div class="logo">
                                    <img src="{{asset('public/ui/images/Group.svg')}}" class="img-fluid" alt="Logo" style="width: 30%;">
                                </div>

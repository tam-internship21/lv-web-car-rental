...
<section class="ftco-section ftco-intro partner" style="background: url(public/ui/images/bg_2.jpg) center;">
    <div class="overlays"></div>
    <div class="container">
        <div class="row justify-content-end">
            <div class="col-md-6 heading-section heading-section-white ftco-animate">
                <h3 class="mb-3 text-white">Become our partner for a chance to earn extra monthly income.</h3>
                <a href="{{route('partner.registration')}}" class="btn btn-secondary btn-lg">Partner Registration</a>
            </div>
        </div>
    </div>
</section>

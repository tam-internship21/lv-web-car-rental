...
<section class="partner-registration hero-wrap-2 js-fullheight">
    <div class="banner-registration hero-wrap-2 js-fullheight content-registration text-white" style="background: url('public/ui/images/bg_3.jpg') center center;background-size: cover;">
        <div class="container">
            <div class="row">

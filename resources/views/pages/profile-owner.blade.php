...
<section class="hero-wrap hero-wrap-4 js-fullheight" style="background-image: url('public/ui/images/bg_2.jpg');" data-stellar-background-ratio="0.5">
        ...
        <div class="row no-gutters js-fullheight-4 align-items-end justify-content-center">
            <div class="profile-owner col-md-9 ftco-animate pb-5 text-center">
                <div class="flex-center transform-center">
                    <img src="{{asset('public/ui/images/person_2.jpg')}}" alt="">
                    <div class="box-info">
    ...
    <div class="container">
        ...
        <div class="comment-owner">
            ...
            <div class="bottom-comment">
                <div class="row">
                    <div class="col-2">
                        <img src="{{asset('public/ui/images/person_1.jpg')}}" alt="">
                    </div>
                    <div class="col-10" style="padding-right: 30px;">
                        <div class="name-cmt">Mr Hoa</div>
                        <div class="row">
                    ...
                    <div class="carousel-car owl-carousel">
                        <div class="item">
                            <div class="car-wrap rounded ftco-animate">
                                <div class="img rounded d-flex align-items-end" style="background-image: url('public/ui/images/car-7.jpg');">
                                </div>
                                <div class="text">
                        ...
                        <div class="item">
                            <div class="car-wrap rounded ftco-animate">
                                <div class="img rounded d-flex align-items-end" style="background-image: url('public/ui/images/car-6.jpg');">
                                </div>
                                <div class="text">
                                    <h2 class="mb-0"><a href="">VINFAST FADIL 2020</a></h2>
                                    <div class="d-flex mb-3">
                        ...
                        <div class="item">
                            <div class="car-wrap rounded ftco-animate">
                                <div class="img rounded d-flex align-items-end" style="background-image: url('public/ui/images/car-2.jpg');">
                                </div>
                                <div class="text">
                                    <h2 class="mb-0"><a href="">VINFAST FADIL 2020</a></h2>
                                    <div class="d-flex mb-3">
                        ...
                        <div class="item">
                            <div class="car-wrap rounded ftco-animate">
                                <div class="img rounded d-flex align-items-end" style="background-image: url('public/ui/images/car-4.jpg');">
                                </div>
                                <div class="text">
                                    <h2 class="mb-0"><a href="">VINFAST FADIL 2020</a></h2>
                                    <div class="d-flex mb-3">

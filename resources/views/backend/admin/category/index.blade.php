                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Danh sách thể loại xe</h5>
                                    ...
                                    <table id="datatable" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$newDateFormat = date('d M Y', strtotime($category->created_at))}}
                                                </td>
                                                <td>{{$newDateFormat = date('d M Y', strtotime($category->updated_at))}}
                                                </td>
                                                <td>

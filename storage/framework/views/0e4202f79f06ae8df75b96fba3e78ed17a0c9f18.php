                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                ...
                                                ?>
                                                <a href="https://ropsten.etherscan.io/address/<?php echo e($value->address); ?>" target="_blank"><?php echo e($value->address); ?></a>
                                            </th>
                                            <th><?php echo e(number_format($value->token_number,0,"",",")); ?></th>                                            
                                            <td>
                                                <?php if($value->status): ?>
                                            ...
                                            <!--td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"  x-placement="bottom-start" >
                                                        <a class="dropdown-item text-danger" href='/<?php echo e(Helper_Dashboard::get_patch()); ?>/<?php echo e(Helper_Dashboard::get_patch(2)); ?>/send/<?php echo e($value->id); ?>'><i class="icon-cursor"></i> Transfer Token</a>
                                                    </div>
                                                </div>
                                            </td-->
                                        </tr>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wallet_wta_finance/public_html/app/Modules/Dashboard/Views/transfer/list.blade.php ENDPATH**/ ?>
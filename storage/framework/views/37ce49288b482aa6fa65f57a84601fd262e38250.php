            ...
            <div class="card-box">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <textarea name="VISA_CONTENT_EN" class="form-control" rows="20"><?php echo e($settings['VISA_CONTENT_EN']); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hcm_tourism/public_html/app/Modules/Dashboard/Views/visa/edit_en.blade.php ENDPATH**/ ?>
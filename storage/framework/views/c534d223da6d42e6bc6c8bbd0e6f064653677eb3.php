                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="<?php echo e(Cookie::get('search_sliders')); ?>" placeholder="Tiêu đề...">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user"><img src='/public/upload/images/slide/large/<?php echo e($value->image); ?>' class="rounded-circle"/></td>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hcm_tourism/public_html/app/Modules/Dashboard/Views/sliders/index.blade.php ENDPATH**/ ?>
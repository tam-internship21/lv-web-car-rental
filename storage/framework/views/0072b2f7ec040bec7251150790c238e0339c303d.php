                    ...
                    <div class="form-inline">
                        <div class="form-group">
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control border-white" name="search" value="<?php echo e(Cookie::get('search_users')); ?>" placeholder="Email...">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img width="50" src="/public/<?php echo e(!empty($value->photo)?'/'.$value->photo:'dashboard/assets/images/users/no-image.svg'); ?>"/></td>
                                            ...
                                            <!--td><a href="https://ropsten.etherscan.io/address/<?php echo e($value->address); ?>" target="_blank"><?php echo e($value->address); ?></a></td-->
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <?php echo e($balance); ?> BNB
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <?php if($value->google2fa_enable): ?>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wallet_wta_finance/public_html/app/Modules/Dashboard/Views/users/index.blade.php ENDPATH**/ ?>
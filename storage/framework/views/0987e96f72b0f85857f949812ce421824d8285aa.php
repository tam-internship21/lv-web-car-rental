            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <div class="form-inline">
                        ...
                        <a href="/<?php echo e(Helper_Dashboard::get_patch()); ?>/<?php echo e(Helper_Dashboard::get_patch(2)); ?>/add/<?php echo e(Helper_Dashboard::get_patch(3)); ?>" class="ladda-button waves-effect waves-light btn btn-blue btn-sm ml-1" data-style="expand-right">
                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user"><img src='/public/upload/images/post/large/<?php echo e($value->image); ?>' class="rounded-circle"/></td>
                                            <td><a href="/<?php echo e(Helper_Dashboard::get_patch()); ?>/<?php echo e(Helper_Dashboard::get_patch(2)); ?>/photo/<?php echo e($value->id); ?>">Hình ảnh</a></td>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hcm_tourism/public_html/app/Modules/Dashboard/Views/post/index.blade.php ENDPATH**/ ?>
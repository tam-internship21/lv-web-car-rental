        ...
        <tbody>
            <tr>
                <td style="text-align: center;padding: 30px;">
                    ...
                    <p style="text-align: left;color: #606060;font-size: 14px;">Welcome to Ho Chi Minh City! You have successfully registered. Please use the registered email and password to sign in to the App for a better experience.</p>
...
</html><?php /**PATH /home/hcm_tourism/public_html/app/Modules/API/Views/email/verify_en.blade.php ENDPATH**/ ?>
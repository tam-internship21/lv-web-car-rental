            ...
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    ...
                    <select class="form-control form-control-sm" name="post_id">
                        ...
                        <option value="<?php echo e($value->id); ?>" <?php echo e(old('post_id',$data->post_id)==$value->id? "selected" :""); ?>><?php echo e($value->title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hcm_tourism/public_html/app/Modules/Dashboard/Views/toppopular/edit.blade.php ENDPATH**/ ?>
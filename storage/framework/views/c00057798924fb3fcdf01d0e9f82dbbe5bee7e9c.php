                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th><a href="/<?php echo e(Helper_Dashboard::get_patch(1)); ?>/withdrawalrule/edit/<?php echo e($value->id); ?>"><?php echo e($value->email); ?></a></th>
                                            <th><a href="https://bscscan.com/address/<?php echo e($value->address); ?>" target="_blank"><?php echo e($value->address); ?></a></th>
                                            <th><?php echo e(number_format($value->total_locked,0,"",",")); ?> <?php echo e($settings['ICO_SYMBOL']); ?></th>   
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"  x-placement="bottom-start" >
                                                        <a class="dropdown-item text-danger" href='/<?php echo e(Helper_Dashboard::get_patch()); ?>/<?php echo e(Helper_Dashboard::get_patch(2)); ?>/delete/[{"id":<?php echo e($value->id); ?>}]'><i class="fe-trash-2"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wallet_wta_finance/public_html/app/Modules/Dashboard/Views/withdrawalrule/index.blade.php ENDPATH**/ ?>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    <label>Mô tả</label>
                    <textarea name="description" rows="5" class="form-control form-control-sm"><?php echo e(old('description',$data->description)); ?></textarea>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card-box">
                ...
                <?php if($data->image!=""): ?>
                <div class="form-group mb-2">
                    <img src="/public/upload/images/slide/large/<?php echo e($data->image); ?>" style="width: auto;max-width: 100%">
                </div>
                <?php endif; ?>
                <div class="form-group mb-2">
                    <?php
...
<?php echo $__env->make('Dashboard::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hcm_tourism/public_html/app/Modules/Dashboard/Views/sliders/edit.blade.php ENDPATH**/ ?>